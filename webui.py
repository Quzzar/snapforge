...
shared.gradio_root = gr.Blocks(
    title="Snapforge", css=modules.html.css, theme=gr.themes.Base()
).queue()
                ...
                with gr.Tabs():
                    ...
                    with gr.TabItem(label="Image Prompt") as ip_tab:
                        ...
                        ip_advanced = gr.Checkbox(
                            label="Advanced", value=False, container=False
                        )
                        gr.HTML(
        ...
        with gr.Column(
            ...
            with gr.Tab(label="Setting"):
                ...
                if not args_manager.args.disable_image_log:
                    gr.HTML(
                        f'<a href="file={get_current_html_path()}" target="_blank">\U0001F4DA History Log</a>'
                    )
            ...
            with gr.Tab(label="Style"):
                ...
                shared.gradio_root.load(
                    lambda: gr.update(choices=copy.deepcopy(style_sorter.all_styles)),
                ...
                with gr.Column(visible=False) as dev_tools:
                    ...
                    with gr.Tab(label="Control"):
                        ...
                        mixing_image_prompt_and_vary_upscale = gr.Checkbox(
                            label="Mixing Image Prompt and Vary/Upscale", value=False
                        )
                        mixing_image_prompt_and_inpaint = gr.Checkbox(
                            label="Mixing Image Prompt and Inpaint", value=False
                        )
